...
const GoldenEditor = ({
  ...
  const StyleHandler = () => {
    if (isSubTask && notion.Tasks.length !== 0) {
  ...
  return (
    <div className="bg-Crayola rounded-[14px] p-10 text-white w-full lg:w-11/12 min-h-[240px] h-max 3xl:min-h-[299px]  mb-[20px] cursor-grab">
      <div
        className="flex items-center justify-end flex-row-reverse w-full"
      ...
      >
        ...
        />
        <div className={`${visible ? "visible" : "invisible"} mr-[10px]`}>
          <DragIcon />
        </div>
      </div>
