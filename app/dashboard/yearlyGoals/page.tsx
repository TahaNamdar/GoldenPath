                ...
                <div className="flex-1 lg:overflow-y-scroll lg:pl-[33rem]  bg-CharlestonGreen rounded-md pl-[2rem] pr-[2rem] md:pl-[3.7rem] md:pr-[4.6rem] h-auto pb-[60px] lg:pb-[unset]">
                    <div className="lg:flex items-center justify-between mb-[3.7rem] mt-[4.5rem]">
                        ...
                        <div className="lg:hidden">
                            ...
                            <a href="https://www.youtube.com/" target="_blank" className="text-base text-white mr-[1.5rem] cursor-pointer underline">
                                26 Y.O Goals
                            </a>
                            <a href="https://www.youtube.com/" target="_blank" className="text-base text-white cursor-pointer underline">
                                {" "}
                                Tutorial
                            </a>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                {notionsList.map((notion: Notion) => {
                                    return <GoldenEditor data={notion} key={notion.id} onFavoriteAdd={onFavoriteAdd} onFavoriteRemove={onFavoriteRemove} onFavoriteUpdate={onFavoriteUpdate} onRemoveNotionCard={onRemoveNotionCard} />;
                                })}
